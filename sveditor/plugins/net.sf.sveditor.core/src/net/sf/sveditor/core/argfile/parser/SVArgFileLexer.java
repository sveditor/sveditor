...
public class SVArgFileLexer extends SVToken {
	...
	public void init(SVToken tok) {
		fImage = tok.getImage();
		fIsIdentifier = tok.isIdentifier();
		fIsKeyword = tok.isKeyword();
		fIsNumber = tok.isNumber();
		fIsOperator = tok.isOperator();
		fIsString = tok.isString();
		fIsTime = tok.isTime();
