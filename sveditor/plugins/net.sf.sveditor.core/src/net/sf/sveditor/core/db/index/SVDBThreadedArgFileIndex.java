...
public class SVDBThreadedArgFileIndex extends AbstractThreadedSVDBIndex {
	private StringBuilder				fArguments;
	
	public SVDBThreadedArgFileIndex(
			String						project,
			String						root,
	...
	protected void discoverRootFiles(List<IJob> jobs) {
		...
		processArgFile(new NullProgressMonitor(), getResolvedBaseLocation());
	}
