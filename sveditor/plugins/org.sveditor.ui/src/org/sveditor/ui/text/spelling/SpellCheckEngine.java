...
import org.sveditor.ui.text.spelling.engine.ISpellDictionary;
import org.sveditor.ui.text.spelling.engine.LocaleSensitiveSpellDictionary;
import org.sveditor.ui.text.spelling.engine.PersistentSpellDictionary;
...
public class SpellCheckEngine implements ISpellCheckEngine, IPropertyChangeListener {
	...
	public static Enumeration<URL> getDictionaryLocations() throws IOException {
		final SVUiPlugin plugin= SVUiPlugin.getDefault();
		if (plugin != null)
...
//		fGlobalDictionaries.add(new TaskTagDictionary());
		...
		SVUiPlugin.getDefault().getPreferenceStore().addPropertyChangeListener(this);
	...
	public synchronized final void shutdown() {
		...
		SVUiPlugin.getDefault().getPreferenceStore().removePropertyChangeListener(this);
